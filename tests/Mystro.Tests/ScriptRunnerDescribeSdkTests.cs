...
{
    private const string ToolsMarkdownRelativePath = ".mystro/agents/tools.md";
    ...
    [Fact]
    public async Task BuildSdk_GeneratesToolsMarkdownUnderMystroAgents()
    {
        var repoRoot = FindRepoRoot();
        var projectPath = Path.Combine(repoRoot, "src", "Mystro.SDK", "Mystro.SDK.csproj");
