...
public class LeadAgentTests
{
    ...
    public async Task AnalyzeTaskAsync_ShouldBuildPromptFromProvidedPractices_AndNormalizeResponse()
    {
        ...
        var promptServiceMock = new Mock<Mystro.Application.Interfaces.IAgentPromptService>();
        ...
        var leadAgent = new Mystro.Application.LeadAgent(resolverMock.Object, promptServiceMock.Object);
        var practices = new[]
        {
    ...
    public async Task AnalyzeTaskAsync_ShouldFail_WhenLeadTemplateUnavailable()
    {
        ...
        var promptServiceMock = new Mock<Mystro.Application.Interfaces.IAgentPromptService>();
        promptServiceMock.Setup(x => x.LoadLeadPromptTemplate())
            .Throws(new InvalidOperationException("Required agent prompt file is missing: /repo/.mystro/agents/lead.md"));
