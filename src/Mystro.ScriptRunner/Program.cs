...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var globals = new ScriptGlobals(new MystroSDK(sdkSink));
        ...
        try
        {
            var scriptOptions = ScriptOptions.Default
                ...
                .AddReferences(typeof(MystroSDK).Assembly)
                .AddImports("Mystro.SDK")
                .AddImports(
                    "System",
                    "System.IO",
                    "System.Linq",
    ...
    private static void PrintUsage()
    {
        ...
        Console.Error.WriteLine("  Mystro.ScriptRunner.dll --body-file <path>");
        Console.Error.WriteLine("  Mystro.ScriptRunner.dll --body <text>");
        Console.Error.WriteLine("  Mystro.ScriptRunner.dll --body-file <path> --result-file <path>");
    }
